...
使用OpenCV的rectangle()方法在图像上绘制矩形。传入绘制的图像、矩形坐标、颜色和线宽。通过直接从rect_coords字典中使用键和列表索引（0 = 左上角*x*，1 = 左上角*y*，2 = 右下角*x*，3 = 右下角*y*）来访问坐标。
...
编辑“提取高度剖面”项目，使得剖面通过位于塔尔西斯山脉的三座火山，如[图 7-19](ch07.xhtml#ch07fig19)所示。
